...
:----:|:------:|---------------------|-------------------------------|---------------------------------------|---------------------------------|
15/100| 5.06. | - | Создала новый репозиторий на GitHub под "To-Do-List", сделала верстку, деплой проекта (в планах - JS) | "To-Do-List" | [Проект](https://github.com/the-all-spark/to-do-list-app)
