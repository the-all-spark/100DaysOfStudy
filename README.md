...
День  |  Дата  |   Теория            |            Практика           |                Проект                 |       Ссылки на материалы, проекты       | 
:----:|:------:|---------------------|-------------------------------|---------------------------------------|------------------------------------------|
...
16/100| 6.06. | - | Написала функции добавления элементов в список (в DOM и в массив), добавила вывод пунктов-примеров, подтягивание статистики. Начала оформлять readme проекта | "To-Do-List" | [To Do List](https://github.com/the-all-spark/to-do-list-app)
